...
class getSecurity_Authentication_Provider_Guard_ApiService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        }, 1), ($container->privates['security.user.provider.concrete.entity_provider'] ?? $container->load('getSecurity_User_Provider_Concrete_EntityProviderService')), 'api', new \Symfony\Component\Security\Core\User\UserChecker(), ($container->services['security.password_encoder'] ?? $container->load('getSecurity_PasswordEncoderService')));
    }
}
